...
public class CreatePostViewModel extends ViewModel {
    ...
    public void createPost(){
        ...
        Post post = new Post(null, communityId.getValue(), newPost.getTitle(), newPost.getContent(), newPost.getIsAnonymous(), newPost.getDate(), newPost.getDate(), newPost.getAuthor(), 0, 0, 0, null, null, newPost.getTags());
